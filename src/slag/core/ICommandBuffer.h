...
namespace slag
{
    ...
    public:
         ...
         */
        virtual void bindGraphicsDescriptorGroup(uint32_t index, DescriptorMemory* memory, uint64_t offset)=0;
        /**
         ...
         * @param offset The offset into the memory the descriptor group data begins
         */
        virtual void bindComputeDescriptorGroup(uint32_t index, DescriptorMemory* memory, uint64_t offset)=0;
