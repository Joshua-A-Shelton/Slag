...
DEFINITION(CLEAR_COLOR,1<<15, VK_PIPELINE_STAGE_TRANSFER_BIT, D3D12_BARRIER_SYNC_RENDER_TARGET)\
DEFINITION(CLEAR_DEPTH,1<<16, VK_PIPELINE_STAGE_TRANSFER_BIT | VK_PIPELINE_STAGE_EARLY_FRAGMENT_TESTS_BIT | VK_PIPELINE_STAGE_LATE_FRAGMENT_TESTS_BIT, D3D12_BARRIER_SYNC_DEPTH_STENCIL)\
