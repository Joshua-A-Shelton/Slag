...
namespace slag
{
    ...
    public:
         ...
         */
        void setSampler(DescriptorIndex* index, uint32_t arrayElement, Sampler* sampler);
        /**
         ...
         */
        void setSampledTexture(DescriptorIndex* index, uint32_t arrayElement, Texture* texture);
        /**
         ...
         */
        void setUniformTexelBuffer(DescriptorIndex* index, uint32_t arrayElement, BufferView* bufferView);
        /**
         ...
         * @param length The length from the offset of the buffer to use as texel data
         */
        void setStorageTexelBuffer(DescriptorIndex* index, uint32_t arrayElement, BufferView* bufferView);
        /**
         ...
         */
        void setUniformBuffer(DescriptorIndex* index, uint32_t arrayElement, Buffer* buffer, size_t offset, size_t length);
        /**
         ...
         * @param length The size of the data
         */
        void setStorageBuffer(DescriptorIndex* index, uint32_t arrayElement, Buffer* buffer, size_t offset, size_t length);
