...
DEFINITION(NONE,VK_ACCESS_NONE,UNDEFINED) \
DEFINITION(INDIRECT_COMMAND_READ_BIT,VK_ACCESS_INDIRECT_COMMAND_READ_BIT,UNDEFINED) \
DEFINITION(INDEX_READ_BIT,VK_ACCESS_INDEX_READ_BIT,UNDEFINED)                       \
DEFINITION(ACCESS_VERTEX_ATTRIBUTE_READ_BIT,VK_ACCESS_VERTEX_ATTRIBUTE_READ_BIT,UNDEFINED)                       \
DEFINITION(ACCESS_UNIFORM_READ_BIT,VK_ACCESS_UNIFORM_READ_BIT,UNDEFINED)                       \
DEFINITION(ACCESS_INPUT_ATTACHMENT_READ_BIT,VK_ACCESS_INPUT_ATTACHMENT_READ_BIT,UNDEFINED)                       \
DEFINITION(ACCESS_SHADER_READ_BIT,VK_ACCESS_SHADER_READ_BIT,UNDEFINED)                       \
DEFINITION(ACCESS_SHADER_WRITE_BIT,VK_ACCESS_SHADER_WRITE_BIT,UNDEFINED)                       \
DEFINITION(ACCESS_COLOR_ATTACHMENT_READ_BIT,VK_ACCESS_COLOR_ATTACHMENT_READ_BIT,UNDEFINED)                       \
DEFINITION(ACCESS_COLOR_ATTACHMENT_WRITE_BIT,VK_ACCESS_COLOR_ATTACHMENT_WRITE_BIT,UNDEFINED)                       \
DEFINITION(ACCESS_DEPTH_STENCIL_ATTACHMENT_READ_BIT,VK_ACCESS_DEPTH_STENCIL_ATTACHMENT_READ_BIT,UNDEFINED)                       \
DEFINITION(ACCESS_DEPTH_STENCIL_ATTACHMENT_WRITE_BIT,VK_ACCESS_DEPTH_STENCIL_ATTACHMENT_WRITE_BIT,UNDEFINED)                       \
DEFINITION(ACCESS_TRANSFER_READ_BIT,VK_ACCESS_TRANSFER_READ_BIT,UNDEFINED)                       \
DEFINITION(ACCESS_TRANSFER_WRITE_BIT,VK_ACCESS_TRANSFER_WRITE_BIT,UNDEFINED)                       \
DEFINITION(ACCESS_HOST_READ_BIT,VK_ACCESS_HOST_READ_BIT,UNDEFINED)                       \
DEFINITION(ACCESS_HOST_WRITE_BIT,VK_ACCESS_HOST_WRITE_BIT,UNDEFINED)                       \
DEFINITION(ACCESS_MEMORY_READ_BIT,VK_ACCESS_MEMORY_READ_BIT,UNDEFINED)                       \
DEFINITION(ACCESS_MEMORY_WRITE_BIT,VK_ACCESS_MEMORY_WRITE_BIT,UNDEFINED)                       \
...
#undef DEFINITION
    ...
    struct ImageMemoryBarrier
    {
        ...
        PipelineAccess::PipeLineAccessFlags srcAccess;
        PipelineAccess::PipeLineAccessFlags dstAccess;
        Texture* texture;
    };
