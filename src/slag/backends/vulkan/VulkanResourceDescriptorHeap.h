...
namespace slag
{
    namespace vulkan
    {
        ...
        public:
            ...
            void setUniformTexture(uint32_t index, Texture* texture)override;
            void setUnorderedAccessTexture(uint32_t index, Texture* texture)override;
            void setUniformBuffer(uint32_t index, Buffer* buffer, uint32_t offset, uint32_t length)override;
            void setStorageBuffer(uint32_t index, Buffer* buffer, uint32_t offset, uint32_t length)override;
            void setUniformTexelBuffer(uint32_t index, Buffer* buffer, PixelFormat format, uint32_t offset, uint32_t length)override;
            void setStorageTexelBuffer(uint32_t index, Buffer* buffer, PixelFormat format, uint32_t offset, uint32_t length)override;
