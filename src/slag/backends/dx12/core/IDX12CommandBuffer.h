...
namespace slag
{
    namespace dx12
    {
        ...
        */
         ...
         */
        virtual void copyBufferToTexture(Buffer* source, Texture* destination,TextureBufferMapping* mappings, uint32_t mappingCount,TextureLayouts::Layout destinationLayout)override;
#endif
