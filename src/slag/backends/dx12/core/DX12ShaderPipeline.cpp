...
namespace slag
{
    namespace dx12
    {
        DX12ShaderPipeline::DX12ShaderPipeline(ShaderCode** shaders, size_t shaderCount, ShaderProperties& properties,VertexDescription& vertexDescription, FrameBufferDescription& framebufferDescription, std::string(*rename)(const std::string&,uint32_t,Descriptor::Type, uint32_t,void*), void* renameData)
        {
        ...
        DX12ShaderPipeline::DX12ShaderPipeline(const ShaderCode& computeShader,std::string(* rename)(const std::string&,uint32_t,Descriptor::Type, uint32_t,void*), void* renameData)
        {
        ...
        void DX12ShaderPipeline::spirvConstruct(ShaderCode** shaders, size_t shaderCount, ShaderProperties& properties,VertexDescription& vertexDescription, FrameBufferDescription& framebufferDescription,std::string(*rename)(const std::string&,uint32_t,Descriptor::Type, uint32_t,void*), void* renameData)
        {
            throw std::runtime_error("SPIRV isn't supported yet for Direct X 12 Backend");
        }

        void DX12ShaderPipeline::dxilConstruct(ShaderCode** shaders, size_t shaderCount, ShaderProperties& properties,VertexDescription& vertexDescription, FrameBufferDescription& framebufferDescription,std::string(*rename)(const std::string&,uint32_t,Descriptor::Type , uint32_t,void*), void* renameData)
        {
