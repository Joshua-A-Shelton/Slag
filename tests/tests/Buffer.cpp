...
TEST_F(BufferTest, SetSamplerDescriptor)
{
    GTEST_FAIL();
}
TEST_F(BufferTest, SetSampledTextureDescriptor)
{
    GTEST_FAIL();
}
TEST_F(BufferTest, SetStorageTextureDescriptor)
{
    GTEST_FAIL();
}
TEST_F(BufferTest, SetUniformTexelBufferDescriptor)
{
    GTEST_FAIL();
}
TEST_F(BufferTest, SetStorageTexelBufferDescriptor)
{
    GTEST_FAIL();
}
TEST_F(BufferTest, SetUniformBufferDescriptor)
{
    GTEST_FAIL();
}
TEST_F(BufferTest, SetStorageBufferDescriptor)
{
    GTEST_FAIL();
}

#ifdef SLAG_DEBUG
TEST_F(BufferTest, SetSamplerDescriptorFailOnWrongType)
{
    GTEST_FAIL();
}
TEST_F(BufferTest, SetSampledTextureDescriptorFailOnWrongType)
{
    GTEST_FAIL();
}
TEST_F(BufferTest, SetStorageTextureDescriptorFailOnWrongType)
{
    GTEST_FAIL();
}
TEST_F(BufferTest, SetUniformTexelBufferDescriptorFailOnWrongType)
{
    GTEST_FAIL();
}
TEST_F(BufferTest, SetStorageTexelBufferDescriptorFailOnWrongType)
{
    GTEST_FAIL();
}
TEST_F(BufferTest, SetUniformBufferDescriptorFailOnWrongType)
{
    GTEST_FAIL();
}
TEST_F(BufferTest, SetStorageBufferDescriptorFailOnWrongType)
{
    GTEST_FAIL();
}
#endif
