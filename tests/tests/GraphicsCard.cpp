...
TEST(GraphicsCard, Defragment)
{
    ...
    for (auto i=0u; i< Slag::backend()->graphicsCardCount(); i++)
    {
        ...
        auto texture1 = std::unique_ptr<Texture>(card->newTexture2D(PixelFormat::R8G8B8A8_UNORM,TextureUsageFlags::SAMPLED,500,500));
        auto texture2 = std::unique_ptr<Texture>(card->newTexture2D(PixelFormat::R8G8B8A8_UNORM,TextureUsageFlags::SAMPLED,500,500));
        auto texture3 = std::unique_ptr<Texture>(card->newTexture2D(PixelFormat::R8G8B8A8_UNORM,TextureUsageFlags::SAMPLED,250,250));
        auto texture4 = std::unique_ptr<Texture>(card->newTexture2D(PixelFormat::R8G8B8A8_UNORM,TextureUsageFlags::SAMPLED,1500,1500));
        auto texture5 = std::unique_ptr<Texture>(card->newTexture2D(PixelFormat::R8G8B8A8_UNORM,TextureUsageFlags::SAMPLED,250,250));
        auto texture6 = std::unique_ptr<Texture>(card->newTexture2D(PixelFormat::R8G8B8A8_UNORM,TextureUsageFlags::SAMPLED,750,750));
