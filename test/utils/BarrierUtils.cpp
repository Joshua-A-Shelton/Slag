...
namespace slag
{
    BarrierAccess BarrierUtils::compatibleAccess(Texture::Layout layout)
    {
        switch (layout)
        {
    ...
    BarrierAccess BarrierUtils::compatibleAccess(Texture* texture)
    {
    ...
    BarrierAccess BarrierUtils::compatibleAccess(GpuQueue::QueueType queueType)
    {
    ...
    BarrierAccess BarrierUtils::compatibleAccess(Texture* texture, Texture::Layout toLayout, GpuQueue::QueueType queueType)
    {
